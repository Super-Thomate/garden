...
-- PWET
CREATE TABLE IF NOT EXISTS pwet_table (emoji_str TEXT NOT NULL, guild_id INT NOT NULL, PRIMARY KEY (guild_id)) ;
-- RULES
CREATE TABLE IF NOT EXISTS rules_config (log_channel_id INT NOT NULL, guild_id INT NOT NULL, PRIMARY KEY (guild_id)) ;
CREATE TABLE IF NOT EXISTS rules_table (emoji_str TEXT NOT NULL, rule TEXT NOT NULL, guild_id INT NOT NULL, PRIMARY KEY (emoji_str, guild_id)) ;
CREATE TABLE IF NOT EXISTS rules_warned (emoji_str TEXT NOT NULL, message_id INT NOT NULL, guild_id INT NOT NULL, PRIMARY KEY (emoji_str, message_id, guild_id)) ;
-- VOTE
...
CREATE TABLE IF NOT EXISTS vote_proposition (emoji_str TEXT NOT NULL, proposition TEXT NOT NULL, vote_name TEXT NOT NULL, guild_id INT NOT NULL, PRIMARY KEY (emoji_str, vote_name, guild_id)) ;
-- NICKNAME
