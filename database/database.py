...
class Database:
  ...
  def create_table(self):
    ...
    try:
      ...
      cursor.execute('CREATE TABLE IF NOT EXISTS `type_delay` (`delay` INTEGER NOT NULL, `type_delay` VARCHAR(128) NOT NULL, `guild_id` VARCHAR(256) NOT NULL, PRIMARY KEY (`type_delay`, `guild_id`)) ;')
