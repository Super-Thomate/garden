...
def create_table():
  ...
  try:
    ...
    ### BIRTHDAY COG
    cursor.execute('CREATE TABLE IF NOT EXISTS `birthday_user` (`user_id` VARCHAR(256) NOT NULL, `guild_id` VARCHAR(256) NOT NULL, `user_birthday` VARCHAR(5), `last_year_wished` VARCHAR(4), PRIMARY KEY (`user_id`, `guild_id`)) ;')
    ...
    cursor.execute('CREATE TABLE IF NOT EXISTS `source_source_pattern` (`pattern` TEXT NOT NULL, `guild_id` VARCHAR(256) NOT NULL, PRIMARY KEY (`pattern`, `guild_id`)) ;')
    cursor.execute('CREATE TABLE IF NOT EXISTS `source_source_no_pattern` (`pattern` TEXT NOT NULL, `guild_id` VARCHAR(256) NOT NULL, PRIMARY KEY (`pattern`, `guild_id`)) ;')
    ### RULES COG
    """
